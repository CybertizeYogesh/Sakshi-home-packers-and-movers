        ...
        <div className="row">
          ...
          <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
            <div className="about-2-content-area pl-50">
              ...
              <p className="mb-35">Om Relocation Movers and Packers in Ahmedabad is a reliable relocation service provider, known for its professional and efficient moving solutions. Their experienced team ensures the safe and timely delivery of your belongings, making every move stress-free.</p>
              ...
              <div className="about-2-btn-area">
                ...
                <div className="call-us"><div className="icon-1"><i className="fal fa-phone-volume"></i></div><div className="content p-relative"><span>Call Us Now</span><h5><a href="tel:+919752828166">+91 975-282-8166</a></h5></div></div>
              </div>
            </div>
          </div>
        </div>
