              ...
              <div className="header-main">
                <div className="header-left">
                  <div className="header-logo">
                    <a href="/"><img alt="Sakshi Home Packers and Movers logo" width="63" height="55" src={sticky ? "/assets/img/logo-colored.svg" : "/assets/img/logo-white.svg"} /></a>
                  </div>
                </div>
            ...
            <div className="offcanvas__content">
              <div className="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                <div className="offcanvas__logo">
                  <a href="/"><img alt="Sakshi Home Packers and Movers logo" width="63" height="55" src="/assets/img/logo-white.svg" /></a>
                </div>
